...
class WidgetMenuListTile extends StatefulWidget {
  ...
  Color subTitleColor;
  Widget icon;
  WidgetMenuListTile({Key? key, required this.iconColor,required this.icon,required this.title,required this.subtitle,required this.titleColor,required this.subTitleColor}) : super(key: key);
