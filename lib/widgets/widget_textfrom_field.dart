...
class _CustomTextFormFieldState extends State<WidgetTextFormField> {
        ...
        children: [
          Container(
            ...
            child: TextFormField(
              ...
              maxLines: widget.isFieldExpanded ? null : widget.maxLine,
              minLines: widget.isFieldExpanded ? null :widget.minLine,
