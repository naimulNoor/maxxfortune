...
class RefundRequestDetailsView extends StatefulWidget {
  ...
  @override
  _RefundRequestDetailsViewState createState() =>
      _RefundRequestDetailsViewState();
}

class _RefundRequestDetailsViewState extends State<RefundRequestDetailsView> {
  @override
...
class AdminResponseWidget extends StatelessWidget {
  const AdminResponseWidget({
    Key? key,
  }) : super(key: key);
